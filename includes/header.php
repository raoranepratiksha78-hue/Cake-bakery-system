                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                <li class="dropdown submenu <?php echo $currentPage == 'index.php' ? 'active' : ''; ?>">
                                    <a class="dropdown-toggle"  href="index.php" role="button" aria-haspopup="true" aria-expanded="false">Home</a>
                                   
                                </li>
                                <li class="<?php echo $currentPage == 'cake.php' ? 'active' : ''; ?>"><a href="cake.php">Our Cakes</a></li>
                                <li class="dropdown submenu <?php echo $currentPage == 'category-details.php' ? 'active' : ''; ?>">
...
?>
                                 ...
                                 <li class="<?php echo $currentPage == 'about-us.php' ? 'active' : ''; ?>"><a href="about-us.php">About Us</a></li>
                                
                            </ul>
                            <ul class="navbar-nav justify-content-end">
                               <?php if (strlen($_SESSION['fosuid']==0)) {?>
                                <li class="<?php echo $currentPage == 'registration.php' ? 'active' : ''; ?>"><a href="registration.php">Sign up</a></li>
                                <li class="<?php echo $currentPage == 'login.php' ? 'active' : ''; ?>"><a href="login.php">Sign in</a></li>
                                <li class="<?php echo $currentPage == 'track-order.php' ? 'active' : ''; ?>"><a href="track-order.php">Track Order</a></li><?php } ?>
                                <?php if (strlen($_SESSION['fosuid']>0)) {?>
                                <li class="dropdown submenu <?php echo in_array($currentPage, ['profile.php', 'change-password.php']) ? 'active' : ''; ?>">
                                ...
                                <li class="<?php echo $currentPage == 'cart.php' ? 'active' : ''; ?>"><a href="cart.php">Cart Page</a></li>
                                <li class="<?php echo $currentPage == 'my-order.php' ? 'active' : ''; ?>"><a href="my-order.php">My Orders</a></li><?php } ?>
                                
                                <li class="<?php echo $currentPage == 'contact.php' ? 'active' : ''; ?>"><a href="contact.php">Contact Us</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
